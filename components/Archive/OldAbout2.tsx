    ...
    return(
        <>
            <section id="about" className="relative h-[100dvh]">
                <div className="flex justify-center h-full pt-[60px]">
                    <div className="flex flex-col md:flex-row justify-center items-center md:items-start mt-auto mb-auto w-[80%] md:w-[70%] h-full"> 
                        {/* DESKTOP */}
