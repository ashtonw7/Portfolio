    ...
    return(
        <>
            <div className="flex flex-col items-center w-full expbreak32:w-auto smallphone:py-2 expbreak32:py-6 expbreak32:mr-10 bg-white doodle-border shadow-green-sm expbreak32:shadow-green px-3 expbreak3:px-8 animate-fade-up h-full">
                <div className="flex w-full h-full expbreak32:min-w-0 justify-start expbreak32:justify-center flex-row expbreak32:flex-col">
                    <div className="flex flex-col items-center min-w-[30%] smallphone:min-w-[50%] expbreak32:min-w-0">
                        <h2 className="hidden expbreak32:inline text-xl expbreak3:text-3xl font-bowlby font-extrabold text-center">
                            { place }
                        </h2>
                        ...
                        <h3 className="hidden expbreak32:inline text-[1rem] expbreak3:text-[1.2rem] font-inter font-extrabold text-center whitespace-pre-wrap">
                            { title }
                        </h3>
                    </div>
                    <div className="hidden expbreak32:inline text-lg expbreak3:text-xl font-inter font-semi mt-2 expbreak3:mt-3 whitespace-pre-wrap px-2 py-5">
                        { blurb }
                    </div>
                    <div className="flex flex-col flex-grow justify-center leading-[1rem] expbreak32:hidden">
                        <h2 className="font-bowlby text-md text-center">
                            { place } 
                        </h2>
                        <button className="border border-black border-10 bg-[#00917B] text-white font-inter font-bold rounded-sm px-4 py-2 mt-1" onClick={callShowModal}>
                            DETAILS
                        </button>
                    </div>
                </div>
