            ...
            <section id="contact" className="flex justify-center items-end w-full h-[100dvh]">
                <div className="flex flex-col max-w-[80%] h-[95%] justify-start items-center">
                    <div className="flex flex-col w-full h-full items-center justify-center mb-[10rem]">
                        <div className="flex flex-col w-full bg-white aboutbreak3:mt-[2rem] doodle-border shadow-green-sm aboutbreak3:shadow-green -skew-x-12 animate-slide-in-right">
                        ...
                        <p className="font-inter font-medium text-[1.3rem] bigphone:text-[1.6rem] aboutbreak3:text-[2.2rem] aboutbreak4:text-[2.7rem] animate-fade-up mt-10">
